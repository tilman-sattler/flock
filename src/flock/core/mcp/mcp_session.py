...
from flock.core.mcp.mcp_settings import MCPAuthenticationSettings, MCPClientSettings, MCPConnectionSettings
...
class MCPServerConnection(BaseModel):
    ...
    connection_settings: MCPConnectionSettings = Field(
